...
export const Projects = ()=>{
  ...
  return (
    ...
    <div className="relative m-2"> 
      ...
      <div className="m-3">
      <div className="font-bold border-0 border-b-[2px] border-gradient w-fit" > Game store </div> 
     ...
     <a href="https://games-store-sandy.vercel.app/"> <div  className=" border-0 p-2  bg-[#f6b7] text-white font-bold text-sm rounded w-fit">live site</div></a>
      ...
      <div className="m-3">
      <div className="font-bold border-0 border-b-[2px] border-gradient w-fit" >AI Doctor</div> 
