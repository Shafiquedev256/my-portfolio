  ...
  return (
    ...
    <div className="relative m-2"> 
     ...
     <a href="https://games-store-sandy.vercel.app/"> <div  className=" border-0 p-2  bg-[#f6b7] text-white font-bold text-sm rounded w-fit">live site</div></a>
      ...
      <div className="m-3">
      <div className="font-bold border-0 border-b-[2px] border-gradient w-fit" onClick={()=>{setOpenGym(!openGym)}}>Gym Daddy</div> 
      {
        openGym&&(  <div className="w-72 text-sm space-y-2 border-[2px] border-gradient  p-2   my-2"> 
      <p>
